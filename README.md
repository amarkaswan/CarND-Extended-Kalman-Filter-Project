...
- `json.hpp`: It is an open source single-header C++ library for handling JSON. In particular, itt provides easy, clean ways to read from and write to JSON files.
